...
file_name = "ILovePDF/lang/arb.py"
...
BAN = {
    ...
    "banCB" : {_CREATE_BOT : f"{settings.SOURCE_CODE}", _SOURCE : f"{settings.SOURCE_CODE}", _CHANNEL : "https://telegramic.org/bot/i2pdfbot/"}}
PDF_MESSAGE = {
